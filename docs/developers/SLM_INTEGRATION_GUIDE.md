...
This document provides a deep dive into the architecture and design of the SLM integration module (`src/anon/slm/`). It is intended for developers who want to understand, maintain, or extend the SLM-powered capabilities of AnonShield.
