...
print()
print("  Note: for this specific config (only force_anonymize and")
print("  fields_to_exclude directives, zero fields_to_anonymize entries),")
print("  no field passes through the NER or regex pipeline, so GPU and")
print("  CPU times converge. The CPU gain is therefore larger than on GPU.")
print("══════════════════════════════════════════════════════════════")
PY
