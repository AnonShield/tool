...
print()
print("  Note: with config, GPU and CPU times converge because no field")
print("  passes through the NER or regex pipeline. The CPU gain is")
print("  therefore larger than the GPU gain.")
print("══════════════════════════════════════════════════════════════")
PY
